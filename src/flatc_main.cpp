...
int main(int argc, const char *argv[]) {
  ...
  const flatbuffers::FlatCompiler::Generator generators[] = {
    ...
    { flatbuffers::GenerateLmiCPP, "-lmic", "--lmicpp", "C++", true,
      flatbuffers::GenerateCppGRPC, flatbuffers::IDLOptions::kLmiCpp,
      "Generate C++ headers for LMI json serialization", flatbuffers::LmiCPPMakeRule },
